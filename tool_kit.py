...
if os.geteuid() != 0:
    ...
    print(
        colr().hex(
            "#cc33ff",
            "\n    THIS IS A POWERFUL SCRIPT THAT INSTALL ALL THE KALI LINUX TOOLS AROUND",
            rgb_mode=True,
        ),
        colr().hex("#ff0000", "300+"),
        colr().hex("#cc33ff", "MORE"),
    )
    ...
    # Call tools category and choice function
    def tools_category_choice_call():
        tools_category()
        choices()

    # All category tool install loop function
    class AllKaliLinux:
        def all_kali_linux_tools():
            ...
            Colors.red("\n              WARNING ")
            Colors.sky_blue("\n   1, It takes some more time to install ")
            Colors.sky_blue("\n   2, 300+ more tools install under this command.")
            Colors.sky_blue(
                "\n   3, If you stop the installation your system will get some lag in that time."
            )
            Colors.sky_blue(
                "\n   4, If you start the installation you can't stop it. you wait for the end of the installation. "
            )
            answer = input(
                colr().hex(
                    "#ff0000", "\n You want to run this y or n : ", rgb_mode=True
                )
            )
            ...
            switch = {
                ...
                "yes": all_kali_tools,
                "YES": all_kali_tools,
                "NO": tools_category_choice_call,
                "n": tools_category_choice_call,
                "no": tools_category_choice_call,
                "N": tools_category_choice_call,
            }
    ...
    def vulnerability_tools():
        ...
        Colors.light_green(
            "       [31] Slowhttptest                 [32]  Protos-sip  "
        )
        Colors.light_green(
            "       [33] Unix-privesc-check           [34]  Rtpinsertsound"
        )
        Colors.light_green(
